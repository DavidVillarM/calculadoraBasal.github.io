...
CALCULAR.addEventListener('click', () => {
    ...
    if(DATO > 30){
        ...
        FLU.innerHTML = 'Puede utilizar: Opcion 1: ' + opc1 + ' cc/hr o ' + 'Puede utilizar: Opcion 2: ' + opc2 + ' cc/hr' ;
        MAN.innerHTML = 'Opcion 1: M+M/2 = ' + mantenimiento1 + ' cc/hr' + ' Opcion 2: M+M/2 = ' + mantenimiento2 + ' cc/hr';
